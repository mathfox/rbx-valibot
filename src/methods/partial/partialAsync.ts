...
import { optionalAsync } from "../../schemas/optional";
import type {
	BaseIssue,
	BaseSchema,
	BaseSchemaAsync,
 ...
 */
export function partialAsync<const TSchema extends Schema>(schema: TSchema): SchemaWithPartialAsync<TSchema, undefined>;
 ...
 * @returns An object schema.
 */
export function partialAsync<const TSchema extends Schema, const TKeys extends ObjectKeys<TSchema>>(
	schema: TSchema,
	keys: TKeys,
): SchemaWithPartialAsync<TSchema, TKeys>;
