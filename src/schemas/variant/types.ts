...
type VariantOption<TKey extends string> =
	| LooseObjectSchema<
	  ...
	  >
	| ObjectSchema<Record<TKey, BaseSchema<unknown, unknown, BaseIssue<unknown>>>, ErrorMessage<ObjectIssue> | undefined>
 ...
 */
export type InferVariantIssue<TOptions extends VariantOptions<string> | VariantOptionsAsync<string>> = Exclude<
