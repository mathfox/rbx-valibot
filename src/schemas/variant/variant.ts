 ...
 */
export function variant<const TKey extends string, const TOptions extends VariantOptions<TKey>>(
	key: TKey,
	options: TOptions,
): VariantSchema<TKey, TOptions, undefined>;
...
>(key: TKey, options: TOptions, message: TMessage): VariantSchema<TKey, TOptions, TMessage>;
