...
>(wrapped: TWrapped, default_: TDefault): NullishSchemaAsync<TWrapped, TDefault>;
	...
	> = {
		...
		async _run(dataset, config) {
			...
			if (dataset.value === null || dataset.value === undefined) {
				...
				if ("default" in this) {
					dataset.value = await getDefault(this, dataset as Dataset<null | undefined, never>, config);
				}
