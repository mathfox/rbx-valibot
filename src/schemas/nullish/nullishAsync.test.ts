...
import { type NullishSchemaAsync, nullishAsync } from "./nullishAsync.ts";

describe("nullishAsync", () => {
	describe("should return schema object", () => {
		const baseSchema: Omit<NullishSchemaAsync<StringSchema<undefined>, string>, "default"> = {
			kind: "schema",
			type: "nullish",
	...
	describe("should return dataset with default", () => {
		...
		test("for undefined", async () => {
			expect(await schema1._run({ typed: false, value: undefined }, {})).toStrictEqual({ typed: true, value: null });
			expect(await schema2._run({ typed: false, value: undefined }, {})).toStrictEqual({
				typed: true,
				value: undefined,
			});
			expect(await schema3._run({ typed: false, value: undefined }, {})).toStrictEqual({ typed: true, value: "foo" });
			expect(await schema4._run({ typed: false, value: undefined }, {})).toStrictEqual({ typed: true, value: null });
			expect(await schema5._run({ typed: false, value: undefined }, {})).toStrictEqual({
				typed: true,
				value: undefined,
			});
			expect(await schema6._run({ typed: false, value: undefined }, {})).toStrictEqual({ typed: true, value: "foo" });
			expect(await schema7._run({ typed: false, value: undefined }, {})).toStrictEqual({ typed: true, value: null });
			expect(await schema8._run({ typed: false, value: undefined }, {})).toStrictEqual({
				typed: true,
				value: undefined,
			});
			expect(await schema9._run({ typed: false, value: undefined }, {})).toStrictEqual({ typed: true, value: "foo" });
		});

		test("for null", async () => {
			expect(await schema1._run({ typed: false, value: null }, {})).toStrictEqual({
				typed: true,
				value: null,
			});
			expect(await schema2._run({ typed: false, value: null }, {})).toStrictEqual({
				typed: true,
				value: undefined,
			});
			expect(await schema3._run({ typed: false, value: null }, {})).toStrictEqual({
				typed: true,
				value: "foo",
			});
			expect(await schema4._run({ typed: false, value: null }, {})).toStrictEqual({
				typed: true,
				value: null,
			});
			expect(await schema5._run({ typed: false, value: null }, {})).toStrictEqual({
				typed: true,
				value: undefined,
			});
			expect(await schema6._run({ typed: false, value: null }, {})).toStrictEqual({
				typed: true,
				value: "foo",
			});
			expect(await schema7._run({ typed: false, value: null }, {})).toStrictEqual({
				typed: true,
				value: null,
			});
			expect(await schema8._run({ typed: false, value: null }, {})).toStrictEqual({
				typed: true,
				value: undefined,
			});
			expect(await schema9._run({ typed: false, value: null }, {})).toStrictEqual({
				typed: true,
				value: "foo",
			});
		});
