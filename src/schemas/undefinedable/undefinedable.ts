 ...
 */
export function undefinedable<const TWrapped extends BaseSchema<unknown, unknown, BaseIssue<unknown>>>(
	wrapped: TWrapped,
): UndefinedableSchema<TWrapped, never>;
...
>(wrapped: TWrapped, default_: TDefault): UndefinedableSchema<TWrapped, TDefault>;
...
export function undefinedable(
	...
	// @ts-expect-error
	const schema: UndefinedableSchema<BaseSchema<unknown, unknown, BaseIssue<unknown>>, unknown> = {
		kind: "schema",
		type: "undefinedable",
