 ...
 * @returns A NaN schema.
 */
export function nan<const TMessage extends ErrorMessage<NanIssue> | undefined>(message: TMessage): NanSchema<TMessage>;

export function nan(message?: ErrorMessage<NanIssue>): NanSchema<ErrorMessage<NanIssue> | undefined> {
	return {
		kind: "schema",
		type: "nan",
		reference: nan,
