...
import { type NonNullishSchemaAsync, nonNullishAsync } from "./nonNullishAsync.ts";
...
describe("nonNullishAsync", () => {
	describe("should return schema object", () => {
		...
		const baseSchema: Omit<
			NonNullishSchemaAsync<NullishSchemaAsync<StringSchema<undefined>, undefined>, never>,
			"message"
		> = {
			kind: "schema",
			type: "non_nullish",
		...
		test("with undefined message", () => {
			const schema: NonNullishSchemaAsync<NullishSchemaAsync<StringSchema<undefined>, undefined>, undefined> = {
				...baseSchema,
				message: undefined,
			};
		...
		test("with string message", () => {
			expect(nonNullishAsync(wrapped, "message")).toStrictEqual({
				...baseSchema,
				message: "message",
			} satisfies NonNullishSchemaAsync<NullishSchemaAsync<StringSchema<undefined>, undefined>, "message">);
		});
		...
		test("with function message", () => {
			...
			expect(nonNullishAsync(wrapped, message)).toStrictEqual({
				...baseSchema,
				message,
			} satisfies NonNullishSchemaAsync<NullishSchemaAsync<StringSchema<undefined>, undefined>, typeof message>);
		});
	});
