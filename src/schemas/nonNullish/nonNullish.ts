...
import type { InferNonNullishInput, InferNonNullishIssue, InferNonNullishOutput, NonNullishIssue } from "./types.ts";
 ...
 */
export function nonNullish<const TWrapped extends BaseSchema<unknown, unknown, BaseIssue<unknown>>>(
	wrapped: TWrapped,
): NonNullishSchema<TWrapped, undefined>;
...
): NonNullishSchema<BaseSchema<unknown, unknown, BaseIssue<unknown>>, ErrorMessage<NonNullishIssue> | undefined> {
	return {
		kind: "schema",
		type: "non_nullish",
