...
//		const options = [object({ key1: string() }), objectAsync({ key2: number() })] as const;
...
//				message: undefined,
//			};
//			expect(intersectAsync(options)).toEqual(schema);
//			expect(intersectAsync(options, undefined)).toEqual(schema);
//		});
//
//		test("with string message", () => {
//			expect(intersectAsync(options, "message")).toEqual({
//				...baseSchema,
//				message: "message",
