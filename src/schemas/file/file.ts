 ...
 * File schema type.
 */
export interface FileSchema<TMessage extends ErrorMessage<FileIssue> | undefined>
 ...
 * @returns A file schema.
 */
export function file<const TMessage extends ErrorMessage<FileIssue> | undefined>(
	message: TMessage,
): FileSchema<TMessage>;

export function file(message?: ErrorMessage<FileIssue>): FileSchema<ErrorMessage<FileIssue> | undefined> {
	return {
		kind: "schema",
		type: "file",
		reference: file,
