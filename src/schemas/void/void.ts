 ...
 * Void schema type.
 */
export interface VoidSchema<TMessage extends ErrorMessage<VoidIssue> | undefined>
 ...
 * @returns A void schema.
 */
export function void_<const TMessage extends ErrorMessage<VoidIssue> | undefined>(
	message: TMessage,
): VoidSchema<TMessage>;

export function void_(message?: ErrorMessage<VoidIssue>): VoidSchema<ErrorMessage<VoidIssue> | undefined> {
	return {
		kind: "schema",
		type: "void",
		reference: void_,
