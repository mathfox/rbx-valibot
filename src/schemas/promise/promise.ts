 ...
 * Promise schema type.
 */
export interface PromiseSchema<TMessage extends ErrorMessage<PromiseIssue> | undefined>
 ...
 * @returns A promise schema.
 */
export function promise<const TMessage extends ErrorMessage<PromiseIssue> | undefined>(
	message: TMessage,
): PromiseSchema<TMessage>;

export function promise(message?: ErrorMessage<PromiseIssue>): PromiseSchema<ErrorMessage<PromiseIssue> | undefined> {
	return {
		kind: "schema",
		type: "promise",
		reference: promise,
