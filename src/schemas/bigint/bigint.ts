 ...
 * Bigint schema type.
 */
export interface BigintSchema<TMessage extends ErrorMessage<BigintIssue> | undefined>
 ...
 * @returns A bigint schema.
 */
export function bigint<const TMessage extends ErrorMessage<BigintIssue> | undefined>(
	message: TMessage,
): BigintSchema<TMessage>;

export function bigint(message?: ErrorMessage<BigintIssue>): BigintSchema<ErrorMessage<BigintIssue> | undefined> {
	return {
		kind: "schema",
		type: "bigint",
		reference: bigint,
