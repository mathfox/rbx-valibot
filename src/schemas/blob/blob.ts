 ...
 * Blob schema type.
 */
export interface BlobSchema<TMessage extends ErrorMessage<BlobIssue> | undefined>
 ...
 * @returns A blob schema.
 */
export function blob<const TMessage extends ErrorMessage<BlobIssue> | undefined>(
	message: TMessage,
): BlobSchema<TMessage>;

export function blob(message?: ErrorMessage<BlobIssue>): BlobSchema<ErrorMessage<BlobIssue> | undefined> {
	return {
		kind: "schema",
		type: "blob",
		reference: blob,
