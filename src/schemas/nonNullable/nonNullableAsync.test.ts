...
import { type NonNullableSchemaAsync, nonNullableAsync } from "./nonNullableAsync.ts";
...
describe("nonNullableAsync", () => {
	describe("should return schema object", () => {
		...
		const baseSchema: Omit<
			NonNullableSchemaAsync<NullishSchemaAsync<StringSchema<undefined>, undefined>, never>,
			"message"
		> = {
			kind: "schema",
			type: "non_nullable",
		...
		test("with undefined message", () => {
			const schema: NonNullableSchemaAsync<NullishSchemaAsync<StringSchema<undefined>, undefined>, undefined> = {
				...baseSchema,
				message: undefined,
			};
		...
		test("with string message", () => {
			expect(nonNullableAsync(wrapped, "message")).toStrictEqual({
				...baseSchema,
				message: "message",
			} satisfies NonNullableSchemaAsync<NullishSchemaAsync<StringSchema<undefined>, undefined>, "message">);
		});
		...
		test("with function message", () => {
			...
			expect(nonNullableAsync(wrapped, message)).toStrictEqual({
				...baseSchema,
				message,
			} satisfies NonNullableSchemaAsync<NullishSchemaAsync<StringSchema<undefined>, undefined>, typeof message>);
		});
	});
