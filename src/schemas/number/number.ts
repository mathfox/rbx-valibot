 ...
 * Number schema type.
 */
export interface NumberSchema<TMessage extends ErrorMessage<NumberIssue> | undefined>
 ...
 * @returns A number schema.
 */
export function number<const TMessage extends ErrorMessage<NumberIssue> | undefined>(
	message: TMessage,
): NumberSchema<TMessage>;

export function number(message?: ErrorMessage<NumberIssue>): NumberSchema<ErrorMessage<NumberIssue> | undefined> {
	return {
		kind: "schema",
		type: "number",
		reference: number,
