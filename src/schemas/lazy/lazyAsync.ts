...
> extends BaseSchemaAsync<InferInput<TWrapped>, InferOutput<TWrapped>, InferIssue<TWrapped>> {
	/**
	 * The schema type.
	 */
	readonly type: "lazy";
...
export function lazyAsync<
	const TWrapped extends
		| BaseSchema<unknown, unknown, BaseIssue<unknown>>
		| BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>,
>(getter: (input: unknown) => MaybePromise<TWrapped>): LazySchemaAsync<TWrapped> {
	return {
		kind: "schema",
		type: "lazy",
		reference: lazyAsync,
