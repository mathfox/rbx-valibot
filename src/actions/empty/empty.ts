 ...
 * Empty action type.
 */
export interface EmptyAction<TInput extends LengthInput, TMessage extends ErrorMessage<EmptyIssue<TInput>> | undefined>
 ...
 */
export function empty<TInput extends LengthInput>(): EmptyAction<TInput, undefined>;
 ...
 * @returns An empty action.
 */
export function empty<TInput extends LengthInput, const TMessage extends ErrorMessage<EmptyIssue<TInput>> | undefined>(
	message: TMessage,
): EmptyAction<TInput, TMessage>;
