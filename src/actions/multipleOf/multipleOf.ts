 ...
 */
export interface MultipleOfIssue<TInput extends number, TRequirement extends number> extends BaseIssue<TInput> {
	/**
	 * The issue kind.
	 */
...
> extends BaseValidation<TInput, TInput, MultipleOfIssue<TInput, TRequirement>> {
	/**
	 * The action type.
	 */
	readonly type: "multiple_of";
 ...
 */
export function multipleOf<TInput extends number, const TRequirement extends number>(
...
export function multipleOf<
	...
	const TMessage extends ErrorMessage<MultipleOfIssue<TInput, TRequirement>> | undefined,
>(requirement: TRequirement, message: TMessage): MultipleOfAction<TInput, TRequirement, TMessage>;

export function multipleOf(
	requirement: number,
	message?: ErrorMessage<MultipleOfIssue<number, number>>,
): MultipleOfAction<number, number, ErrorMessage<MultipleOfIssue<number, number>> | undefined> {
	return {
		kind: "validation",
		type: "multiple_of",
