 ...
 */
export function size<TInput extends SizeInput, const TRequirement extends number>(
	requirement: TRequirement,
): SizeAction<TInput, TRequirement, undefined>;
...
export function size<
	...
	const TMessage extends ErrorMessage<SizeIssue<TInput, TRequirement>> | undefined,
>(requirement: TRequirement, message: TMessage): SizeAction<TInput, TRequirement, TMessage>;

export function size(
	requirement: number,
	message?: ErrorMessage<SizeIssue<SizeInput, number>>,
): SizeAction<SizeInput, number, ErrorMessage<SizeIssue<SizeInput, number>> | undefined> {
	return {
		kind: "validation",
		type: "size",
		reference: size,
