 ...
 */
export function nonEmpty<TInput extends LengthInput>(): NonEmptyAction<TInput, undefined>;
...
): NonEmptyAction<LengthInput, ErrorMessage<NonEmptyIssue<LengthInput>> | undefined> {
	return {
		kind: "validation",
		type: "non_empty",
		reference: nonEmpty,
