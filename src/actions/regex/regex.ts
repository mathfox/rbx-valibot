 ...
 * Regex action type.
 */
export interface RegexAction<TInput extends string, TMessage extends ErrorMessage<RegexIssue<TInput>> | undefined>
 ...
 */
export function regex<TInput extends string>(requirement: RegExp): RegexAction<TInput, undefined>;
 ...
 * @returns A regex action.
 */
export function regex<TInput extends string, const TMessage extends ErrorMessage<RegexIssue<TInput>> | undefined>(
	requirement: RegExp,
	message: TMessage,
): RegexAction<TInput, TMessage>;
