...
> extends BaseValidation<TInput, TInput, StartsWithIssue<TInput, TRequirement>> {
	/**
	 * The action type.
	 */
	readonly type: "starts_with";
 ...
 */
export function startsWith<TInput extends string, const TRequirement extends string>(
...
export function startsWith<
	...
	const TMessage extends ErrorMessage<StartsWithIssue<TInput, TRequirement>> | undefined,
>(requirement: TRequirement, message: TMessage): StartsWithAction<TInput, TRequirement, TMessage>;

export function startsWith(
	requirement: string,
	message?: ErrorMessage<StartsWithIssue<string, string>>,
): StartsWithAction<string, string, ErrorMessage<StartsWithIssue<string, string>> | undefined> {
	return {
		kind: "validation",
		type: "starts_with",
