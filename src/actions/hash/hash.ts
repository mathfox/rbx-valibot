 ...
 * Hash action type.
 */
export interface HashAction<TInput extends string, TMessage extends ErrorMessage<HashIssue<TInput>> | undefined>
 ...
 */
export function hash<TInput extends string>(types: [HashType, ...HashType[]]): HashAction<TInput, undefined>;
 ...
 * @returns A hash action.
 */
export function hash<TInput extends string, const TMessage extends ErrorMessage<HashIssue<TInput>> | undefined>(
