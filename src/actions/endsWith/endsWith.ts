 ...
 */
export function endsWith<TInput extends string, const TRequirement extends string>(
...
export function endsWith<
	...
	const TMessage extends ErrorMessage<EndsWithIssue<TInput, TRequirement>> | undefined,
>(requirement: TRequirement, message: TMessage): EndsWithAction<TInput, TRequirement, TMessage>;

export function endsWith(
	requirement: string,
	message?: ErrorMessage<EndsWithIssue<string, string>>,
): EndsWithAction<string, string, ErrorMessage<EndsWithIssue<string, string>> | undefined> {
	return {
		kind: "validation",
		type: "ends_with",
		reference: endsWith,
